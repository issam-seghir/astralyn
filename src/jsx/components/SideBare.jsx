					...
					<Link component={RouterLink} to="/">
						<svg viewBox="-102.4 -102.4 1228.80 1228.80" fill="red" width={"1em"} height={"1em"} color={"var(--Icon-color)"} fontSize={40} strokeWidth="0.01024" transform="matrix(-1, 0, 0, 1, 0, 0)rotate(-45)">
							<g id="SVGRepo_iconCarrier">
								...
								<path d="M511.8 256.6c24.4 0 44.2 19.8 44.2 44.2S536.2 345 511.8 345s-44.2-19.8-44.2-44.2 19.9-44.2 44.2-44.2m0-20c-35.5 0-64.2 28.7-64.2 64.2s28.7 64.2 64.2 64.2 64.2-28.7 64.2-64.2-28.7-64.2-64.2-64.2z" fill="var(--joy-palette-primary-400)"></path>
								<path
								...
								></path>
								<path d="M512 819.3c8.7 0 24.7 22.9 24.7 60.4s-16 60.4-24.7 60.4-24.7-22.9-24.7-60.4 16-60.4 24.7-60.4m0-20c-24.7 0-44.7 36-44.7 80.4 0 44.4 20 80.4 44.7 80.4s44.7-36 44.7-80.4c0-44.4-20-80.4-44.7-80.4z" fill="var(--joy-palette-primary-400)"></path>
							</g>
						</svg>
					</Link>
